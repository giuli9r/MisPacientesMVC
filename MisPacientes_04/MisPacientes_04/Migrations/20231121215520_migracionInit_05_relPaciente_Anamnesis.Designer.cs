...
namespace MisPacientes_04.Migrations
{
    ...
    [Migration("20231121215520_migracionInit_05_relPaciente_Anamnesis")]
    partial class migracionInit_05_relPaciente_Anamnesis
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MisPacientes_04.Models.Paciente", b =>
                {
                    b.HasOne("MisPacientes_04.Models.Anamnesis", "Anamnesis")
                        .WithOne("Paciente")
                        .HasForeignKey("MisPacientes_04.Models.Paciente", "AnamnesisRefId");
